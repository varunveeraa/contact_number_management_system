...
#include<stdio.h>
using namespace std;
ifstream fin; ofstream fout; fstream finout;
struct node
{
 char fname[20];
 char lname[20];
...
void contact::insert()
{
 node *temp=new node;
 cout<<"\nEnter the details:";
 cout<<"\nFirst Name: ";cin>>temp->fname;
 cout<<"Last name: ";cin>>temp->lname;
 cout<<"Age: ";cin>>temp->age;
 cout<<"Sex: ";cin>>temp->sex;
 cout<<"Number: ";cin>>temp->num;
 cout<<"E-mail id: ";cin>>temp->email;
 cout<<"Birthday:(ddmmyyyy) ";cin>>temp->bday;
...
void contact::edit()
{
 ...
 if(found=='n'){cout<<"\nContact not found!"; return;}
cout<<"\n\nEnter new details: ";
cout<<"\nNew Last name: (Enter '.' to retain old one)";cin>>lname1;
if(strcmp(lname1,".")!=0)
strcpy(ptr->lname,lname1);
cout<<"\nNew Age: (Enter '0' to retain old one)";cin>>age1;
if(age1!=0)
ptr->age=age1;
 cout<<"\nNew Sex: (Enter '.' to retain old one)";cin>>sex1;
if(sex1!='.')
ptr->sex=sex1;
cout<<"\nNew Number: (Enter '.' to retain old one)";cin>>num1;
if(strcmp(num1,".")!=0)
strcpy(ptr->num,num1);
cout<<"\nNew Email id: (Enter '.' to retain old one)";cin>>email1;
if(strcmp(email1,".")!=0)
strcpy(ptr->email,email1);
cout<<"\nNew Birthday: (Enter '.' to retain old one)";cin>>bday1;
if(strcmp(bday1,".")!=0)
